...
df['Группа вес'] = pd.cut(df['Расчетный вес'], bins=[0, 0.1, 0.15, 0.2, 0.25, 0.5, 1, 5, 30, 100, 1000000],
                          labels=['0-0,1', '0,1-0,15', '0,15-0,2', '0.2-0,25', '0,25-0,5', '0,5-1', '1-5', '5-30',
                                  '30-100', '100+'], right=False)
...
df_pivot = df.pivot_table(index=['Вид доставки', 'дата'], columns=['Группа вес'], values=['деньги'],
                          aggfunc={'деньги': sum})
